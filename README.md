...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jamp9yq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jamp9yq.containers.anotherwebservice.com/
...
```
git clone git@github.com:debujanai/container-jamp9yq.git
cd container-jamp9yq
```
...
```
docker attach container-jamp9yq
```
